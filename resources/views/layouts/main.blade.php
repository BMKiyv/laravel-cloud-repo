...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased background-embed">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                          <a class="nav-link navigation" href="/allstds">Всі підприємства</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navigation" href="/about">Про нас</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link navigation" href="/years">Список за роками</a>
                          </li>
                      </ul>
                    </div>
                  </nav>
