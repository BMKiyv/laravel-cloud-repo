...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative background-embed flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">


            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 minwidth footer-container">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a href="/" style="display:inline-block;" >
                    <img style="width: 100px;" src="/images/dart-logo.jpg" alt="logo">
                    </a>
