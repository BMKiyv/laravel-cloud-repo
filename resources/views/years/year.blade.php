...
<form class="sendform" action="{{route('years-update',$year)}}" method="post">
    @csrf
    ...
    <a href="{{route('years-update',$year)}}"><button type="submit" class="btn btn-primary mt-3">Створити</button></a>
